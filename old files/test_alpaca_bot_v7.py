...
# Add local directory to path to import alpaca_bot_v7
sys.path.append(os.getcwd())
sys.path.append("/Users/ct/Documents/Code Projects/alpaca_bot")

# Mock the dependencies before importing the bot
with patch.dict(os.environ, {
    ...
    # Mock modules that might be missing or require API keys
    sys.modules['vaderSentiment'] = MagicMock()
    sys.modules['vaderSentiment.vaderSentiment'] = MagicMock()
    sys.modules['google.generativeai'] = MagicMock()
    
    # Import V7
    import alpaca_bot_v7

class TestSellLogicV7(unittest.TestCase):
    def setUp(self):
        self.mock_client = MagicMock()
        self.manager = alpaca_bot_v7.PortfolioManager(self.mock_client)
    ...
    def test_smart_exit_take_profit(self):
        ...
        print("\n✅ V7 Test Passed: Smart Exit triggered on MACD Bearish (+5% gain)")
    ...
    def test_hard_take_profit_10_percent(self):
        ...
        # Verify Close Position was called
        self.mock_client.close_position.assert_called_with(symbol)
        print("\n✅ V7 Test Passed: Hard Take Profit triggered at +12% gain")
    ...
    def test_hold_normal_condition(self):
        ...
        print("\n✅ V7 Test Passed: Position HELD (Bullish Technicals, +5% gain)")
        
    def test_hold_no_profit(self):
        """Test Hold: Loss Position -> HOLD"""
        symbol = "TSLA"
        entry_price = 100.0
        ...
        self.mock_client.close_position.assert_not_called()
        print("\n✅ V7 Test Passed: Loss Position HELD (Not panic selling via Smart Exit)")
